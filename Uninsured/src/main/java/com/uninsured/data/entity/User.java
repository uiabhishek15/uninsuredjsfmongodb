...
public class User implements Serializable {
	...
	public User(
			String county,
			String population,
			String population_MOE,
			String uninsured,
			String uninsured_MOE,
			String uninsured_Pct,
			String uninsured_Pct_MOE,
			String population_Under18years,
			String population_Under18years_MOE,
			...
			String population_18to64years,
			String population_18to64years_MOE,
			...
			String population_65yearsandolder,
			...
			String population_19to25years,
			String population_19to25years_MOE,
			...
			String male,
			String male_MOE,
			String male_Uninsured,
			String male_Uninsured_MOE,
			String male_Uninsured_Pct,
			String male_Uninsured_Pct_MOE,
			String female,
			String female_MOE,
			String female_Uninsured,
			String female_Uninsured_MOE,
			String female_Uninsured_Pct,
			String female_Uninsured_Pct_MOE,
			String race_One_Race,
			String race_One_Race_MOE,
			String race_One_Race_Uninsured,
			String race_One_Race_Uninsured_MOE,
			String race_One_Race_Uninsured_Pct,
			String race_One_Race_Uninsured_Pct_MOE,
			String race_One_Race_White,
			String race_One_Race_White_MOE,
			...
			String race_One_Race_Asian,
			String race_One_Race_Asian_MOE,
			...
			String race_Two_or_more_races, String race_Two_or_more_races_MOE,
			...
			String white_not_Hispanic_or_Latino,
			...
			String household_Income, String household_Income_MOE,
			String household_Income_Uninsured,
			String household_Income_Uninsured_MOE,
			String household_Income_Uninsured_Pct,
			String household_Income_Pct_MOE,
